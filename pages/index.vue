<template>
  <div class="bg-gray-800 min-h-screen relative overflow-x-auto">
    <section id="desktop-background">
      <!-- BG PHOTO -->
    ...
    <main class="text-gray-700  mx-auto md:max-w-lg bg-white md:shadow-xl relative">
      <section id="alert">
      ...
      <section id="items" class="pb-12">
        <div class="mt-4 px-3">
          <UiTitle class="text-yellow-500 border-yellow-500">Appetizers</UiTitle>
      ...
      <section v-if="total_count > 0">
        <div class="bg-gray-800 py-12">
          ...
          <div class="flex justify-center pb-8">
            <UiTitle class="text-white border-white">Your Order</UiTitle>
          </div>
